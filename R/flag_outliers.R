...
flag_outliers <- function(lin.mod, df, threshold = 4, noplot, ...) {
  outliers.q <- ProvidenciaChemo::plot_outlier.resids(lin.mod, noplot)
  outliers.cooksd <- ProvidenciaChemo::plot_cooksD(lin.mod, threshold, noplot)
